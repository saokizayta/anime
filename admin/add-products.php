...
echo'idt: chuyển chuyên mục hoặc chọn thích hợp:<br><select name="idt">
 
  <option value="5">Tin Tức 5</option>
  <option value="10">Sự Kiện 10</option>
  <option value="15">Cập Nhật / Bảo Trì 15</option>
</select><p>';
 
 echo'Tên idt: chuyển chuyên mục hoặc chọn thích hợp:<br><select name="tenidt">
 
  <option value="Tin Tức">Tin Tức 5</option>
  <option value="Sự Kiện">Sự Kiện 10</option>
  <option value="Cập Nhật / Bảo Trì">Cập Nhật / Bảo Trì 15</option>
</select><p>';

 
 echo'Tiêu đề:<br><input type="text" name="tieude"  value=""><p>';
 echo 'tóm tắt nội dung:<br><textarea name="tomtatnd" cols="40" rows="6"></textarea><p>';
 echo 'Hình ảnh:<br><input type="text" name="hinhanh"  value=""><br>';
 echo 'Nội dung:<br><textarea name="noidung"   class="ckeditor" cols="40" rows="6"></textarea><p>';
...
//echo 'Date:<br><textarea name="menudate" cols="40" rows="6">'.$row['menudate'].'</textarea><p>';
  ...
  echo 'Người gửi:<br><input type="text" name="nguoigui"  value=""><br>';
...
echo '</textarea><p>';
 ...
 echo 'Menu:<br><select name="menu">
  <option value="0"> không Là Menu</option>
