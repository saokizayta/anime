...
echo '<font color="#FFFFFF">';
 ...
 echo 'idt: bài viết này đang thuộc chuyên mục:<br><select name="idt">
  ...
  echo'Tên idt: chuyển chuyên mục hoặc chọn thích hợp:<br><select name="tenidt">
   <option value="'.$row['tenidt'].'">'.$row['tenidt'].'</option>
 ...
 echo'Tiêu đề:<br><input type="text" name="tieude"  value="'.$row['tieude'].'"><p>';
  echo 'Tóm tắt nội dung:<br><textarea name="tomtatnd" cols="40" rows="6">'.$row['tomtatnd'].'</textarea><p>';
 echo 'Nội dung:<br><textarea name="noidung"  " class="ckeditor" cols="40" rows="6">'.$row['noidung'].'</textarea><p>';
...
//echo 'Date:<br><textarea name="menudate" cols="40" rows="6">'.$row['menudate'].'</textarea><p>';
 ...
 echo 'Hình ảnh:<br><input type="text" name="hinhanh"  value="'.$row['hinhanh'].'"><br>';
